      ...
      <ErrorBoundary>
        ...
        >
          <Routes>
            ...
            <Route path="/home" element={<Home menuState={menuState} />} />
            <Route path="/about" element={<About menuState={menuState} />} />
            <Route
              path="/contact"
              element={<Contact menuState={menuState} />}
            />
            <Route path="/finder" element={<Finder menuState={menuState} />} />
            <Route path="/help" element={<Help menuState={menuState} />} />
            <Route
              path="/reviews"
