      ...
      <section className="navbar--container">
        ...
        >
          ...
          <div
            style={{
              width: "100%",
              height: "3px",
              backgroundColor: activeTab.home ? "#d92323" : "white",
        ...
        >
          ...
          <div
            style={{
              width: "100%",
              height: "3px",
              backgroundColor: activeTab.finder ? "#d92323" : "white",
              transition: "all linear .2s",
            }}
          ></div>
        </div>
        ...
        >
          ...
          <div
            style={{
              width: "100%",
              height: "3px",
              backgroundColor: activeTab.contact ? "#d92323" : "white",
              transition: "all linear .2s",
            }}
          ></div>
        </div>
        ...
        >
          ...
          <div
            style={{
              width: "100%",
              height: "3px",
              backgroundColor: activeTab.about ? "#d92323" : "white",
              transition: "all linear .2s",
            }}
          ></div>
        </div>
        ...
        >
          <Link
            ...
            to="/reviews"
            style={{
              color: activeTab.reviews ? "gray" : "black",
            }}
            onClick={() => toggleUpdate((prev) => !prev)}
          >
            Reviews
          ...
          <div
            style={{
              width: "100%",
              height: "3px",
              backgroundColor: activeTab.reviews ? "#d92323" : "white",
              transition: "all linear .2s",
            }}
          ></div>
        </div>
        ...
        >
          ...
          <div
            style={{
              width: "100%",
              height: "3px",
              backgroundColor: activeTab.help ? "#d92323" : "white",
              transition: "all linear .2s",
            }}
          ></div>
        </div>
