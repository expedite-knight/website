  ...
  return (
    <div className="container" style={{ zIndex: menuState ? "-1 " : "0" }}>
      {emailSent && error ? (
        ...
        <Popup message={"Email sent successfully"} enabled={emailSent} />
      )}
      ...
      <section className="content">
        ...
        >
          ...
          <small style={{ color: "gray" }}>*Dimensions in inches*</small>
        </div>
        ...
        {loading ? (
          ...
          <CustomButton size={20} background={"#d92323"} onClick={handleSubmit}>
            Get Quote
          </CustomButton>
        )}
      </section>
